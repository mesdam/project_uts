...
class Storer_Section_Title extends WP_Customize_Control {
    ...
    public function enqueue()
    {
        ...
        wp_enqueue_style('storer-custom-controls-css', trailingslashit(get_template_directory_uri()) . 'assets/css/customizer.css', array(), '1.0', 'all');
    }
 ...
 */
class Storer_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Storer_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Storer_Customize_Section_Upsell extends WP_Customize_Section {
